...
import { CollectionTree, Collection } from './module.vue';
...
const { data: isCollectionExpanded } = useLocalStorage<boolean>(`settings-collapsed-${props.collection.collection}`, true);
